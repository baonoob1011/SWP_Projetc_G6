...
const DNATestingBlog = () => {
  const articles = [
    {
      id: 1,
      title: "Xét Nghiệm ADN Huyết Thống: Quy Trình và Ý Nghĩa Pháp Lý Tại Việt Nam",
      date: "21/05/2025",
      image: Blog1,
      category: "Huyết Thống",
      excerpt: "Tìm hiểu quy trình xét nghiệm ADN xác định quan hệ huyết thống, thủ tục pháp lý và chi phí thực hiện tại các bệnh viện uy tín...",
      readTime: "5 phút đọc"
    },
    {
      id: 2,
      title: "Thủ Tục Xét Nghiệm ADN Phục Vụ Thủ Tục Dân Sự: Khai Sinh, Nhận Con Nuôi",
      date: "14/05/2025",
      image: Blog2,
      category: "Dân Sự",
      excerpt: "Hướng dẫn chi tiết các thủ tục xét nghiệm ADN phục vụ khai sinh, nhận con nuôi, tranh chấp quyền nuôi con theo quy định pháp luật...",
      readTime: "7 phút đọc"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      image: Blog3,
      category: "Pháp Lý",
      excerpt: "Phân tích các vụ việc tranh chấp thừa kế được giải quyết nhờ xét nghiệm ADN, quy trình tại tòa án và chi phí thực hiện...",
      readTime: "8 phút đọc"
    },
    {
      id: 5,
      ...
      image: Blog4,
      category: "Cơ Sở Y Tế",
      excerpt: "Cập nhật danh sách các bệnh viện, phòng khám được phép thực hiện xét nghiệm ADN có giá trị pháp lý tại Việt Nam...",
      readTime: "10 phút đọc"
    },
    {
      id: 6,
      title: "Xét Nghiệm ADN Cha Con: Quy Trình, Chi Phí và Thời Gian Có Kết Quả",
      date: "15/04/2025",
      image: Blog6,
      category: "Huyết Thống",
      excerpt: "Hướng dẫn toàn diện về xét nghiệm ADN xác định quan hệ cha con, từ chuẩn bị mẫu đến nhận kết quả có giá trị pháp lý...",

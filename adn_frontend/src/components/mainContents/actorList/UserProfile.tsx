    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-teal-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-700 font-medium">Đang tải thông tin người dùng...</p>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 mx-4 max-w-sm w-full transform animate-in slide-in-from-bottom-4 duration-500">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Thông tin hồ sơ của bạn đã được cập nhật và lưu trữ bảo mật trong hệ thống xét nghiệm ADN.
              </p>
              
              <div className="flex justify-center">
                <div className="flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-full border border-emerald-200">
                  <Shield className="w-4 h-4 text-emerald-600" />
                  <span className="text-sm font-semibold text-emerald-800">Dữ liệu được bảo mật</span>
                </div>
              </div>
              ...
              <div className="mt-6">
                <div className="w-full bg-gray-200 rounded-full h-1">
                  <div className="bg-gradient-to-r from-emerald-500 to-green-600 h-1 rounded-full animate-pulse" style={{width: '100%', animation: 'progress 3s linear'}}></div>
                </div>
                <p className="text-xs text-gray-500 mt-2">Thông báo sẽ tự động đóng</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-20 left-10 w-32 h-32 opacity-10">
          <svg viewBox="0 0 100 100" className="w-full h-full animate-spin" style={{animationDuration: '20s'}}>
            <path d="M20,20 Q50,40 80,20 Q50,60 20,80 Q50,60 80,80" stroke="#059669" strokeWidth="2" fill="none" />
        ...
        <div className="absolute bottom-20 right-10 w-24 h-24 opacity-10">
          <svg viewBox="0 0 100 100" className="w-full h-full animate-spin" style={{animationDuration: '15s', animationDirection: 'reverse'}}>
            <path d="M30,10 Q50,30 70,10 Q50,50 30,70 Q50,50 70,70" stroke="#0891b2" strokeWidth="2" fill="none" />
        ...
        <div className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-gradient-to-tr from-blue-200/20 to-cyan-300/20 rounded-full blur-2xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative z-10 pt-20 pb-12 px-4">
        <div className="max-w-lg mx-auto">
          ...
          <div className="text-center mb-12 mt-12">
            ...
            <p className="text-gray-600 text-lg">Quản lý thông tin cá nhân cho dịch vụ xét nghiệm ADN</p>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-emerald-100 relative">
            ...
            <div className="p-8 space-y-8 relative">
              ...
              <div className="absolute inset-0 opacity-5">
                <div className="absolute top-4 right-4 w-20 h-20">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    ...
                    <path d="M25,25 L75,75 M75,25 L25,75" stroke="#059669" strokeWidth="1" />
                  </svg>
                </div>
              </div>
              ...
              {['fullName', 'email', 'phone'].map((field, index) => {
                const labels: Record<string, { icon: React.ReactNode; label: string; type?: string; gradient: string; bgColor: string }> = {
                  fullName: { 
                ...
                return (
                  <div key={field} className="relative group" style={{animationDelay: `${index * 0.1}s`}}>
                    <label className="block text-sm font-bold text-gray-700 mb-3 flex items-center gap-3">
                      <div className={`p-2.5 rounded-xl ${labels[field].bgColor} border border-gray-200/50`}>
                        {labels[field].icon}
                      </div>
                      <div>
                        <div className="text-gray-800">{labels[field].label}</div>
                      </div>
                    </label>
                    <div className="relative">
                      <input
                        ...
                        placeholder={`Nhập ${labels[field].label.toLowerCase()}`}
                      />
                      {editableField !== field && (
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border border-emerald-200">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm text-emerald-800">
                    ...
                    <div className="text-emerald-600">Dữ liệu cá nhân được bảo vệ theo tiêu chuẩn y tế quốc tế</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-3 bg-white/70 backdrop-blur-sm px-6 py-3 rounded-full border border-emerald-100 shadow-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">Nhấp vào trường thông tin để chỉnh sửa</span>
              </div>

      ...
      <div className="max-w-full">
        ...
        <div className="bg-[#405EF3] rounded-lg p-6 mb-6 relative">
          <div className="flex items-center gap-2 mb-3">
            <h2 className="text-white text-lg font-semibold">Lịch sử giao dịch</h2>
          </div>
          {/* Breadcrumb */}
          ...
          <div className="bg-green-500 bg-opacity-30 rounded-lg p-2 max-w-xs">
            ...
            <div className="text-blue-100 text-xl">Tổng giao dịch: {transactions.length}</div>
          </div>

          {/* Transaction icon in header */}
          <div className="absolute right-0 bottom-0 mb-4 mr-40">
            <svg className="h-40 w-40 text-white opacity-20" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white border border-gray-200 rounded-lg mb-6 shadow-sm">
          <div className="p-6">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Tìm kiếm giao dịch</h3>
            ...
            <table className="w-full table-fixed">
              ...
              <tbody className="divide-y-2 divide-gray-200 bg-white">
                {filteredTransactions.map((tx, index) => (
                  <tr key={tx.transactionId} className={`hover:bg-blue-50 transition-colors ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>
                    ...
                    <td className={`px-6 py-4 text-sm font-bold border-r-2 border-gray-200 text-right ${
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600 text-center">
                      <div className="bg-gray-100 px-2 py-1 rounded text-xs font-mono">
                        {dayjs(tx.appointmentDate).format('DD/MM/YYYY')}
                      </div>
                    </td>
                  </tr>
                ))}
        ...
        {!loading && !error && filteredTransactions.length === 0 && transactions.length > 0 && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-800">Không tìm thấy giao dịch phù hợp.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {summary && (
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-800">Tổng kết giao dịch</h3>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-green-600">Người dùng chi</p>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-red-600">Hoàn tiền dịch vụ</p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-sm font-medium text-blue-600">Lợi nhuận</p>

        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 border-r border-gray-200 w-48">
                <div className="flex items-center gap-1">
                  Họ tên
                  <svg className="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l4-4 4 4m0 6l-4 4-4-4" />
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600 border-r border-gray-200 w-32">
                <div className="flex items-center gap-1">
                  Ngày sinh
                  <svg className="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l4-4 4 4m0 6l-4 4-4-4" />
          ...
          <tbody className="divide-y divide-gray-200">
            {searchByphone.map((user, index) => (
              <tr key={index} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm text-gray-800 border-r border-gray-200 w-48">
                  {user.fullName}
                </td>
                <td className="px-4 py-3 text-sm text-gray-600 border-r border-gray-200">
                  {user.idCard}
                </td>
                <td className="px-4 py-3 text-sm text-gray-600 border-r border-gray-200 w-32">
                  {user.dateOfBirth}
                </td>
                <td className="px-4 py-3 text-sm text-gray-600 border-r border-gray-200">
                  {user.gender}

...
const SelectedCivilService = () => {
  ...
  if (!service) {
    return <Typography variant="body1">Dữ liệu dịch vụ không tồn tại.</Typography>;
  }
                ...
                <ListItemText
                  ...
                  secondary={
                    <>
                      ...
                      >
                        {new Date(fb.feedbackResponse?.dateSubmitted).toLocaleDateString() || 'N/A'}
                      </Typography>
                    </>
                  }
                />
        ...
        {feedbackData && (
          <div>
            <Typography variant="h6" sx={{ mt: 3 }}>
              Điểm đánh giá trung bình: {averageRating ? averageRating.toFixed(2) : '0.00'}
            </Typography>

...
import { Plus, User, TestTube, Mail, CheckSquare, FileText, ArrowRight, Shield, Award, Scale, Building, Users, Clock } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100 shadow-lg mb-8">
            ...
            <p className="text-emerald-700 font-medium mb-4">Định nghĩa và mục đích:</p>
            <p className="text-gray-700 leading-relaxed text-lg mb-6">
              Xét nghiệm ADN hành chính là loại xét nghiệm có giá trị pháp lý, được thực hiện theo quy trình nghiêm ngặt 
              và có thể sử dụng làm bằng chứng trong các thủ tục pháp lý, hành chính. Kết quả xét nghiệm được các cơ quan 
              nhà nước công nhận và có thể dùng để giải quyết các vấn đề về quan hệ huyết thống trong pháp luật.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-2xl shadow border border-gray-100 p-8 hover:shadow-lg transition-shadow duration-200">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-emerald-600">Mục đích sử dụng</h3>
            </div>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-center space-x-2 p-3 bg-emerald-50 rounded-lg">
          ...
          <div className="bg-white rounded-2xl shadow border border-gray-100 p-8">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-teal-600">Giấy tờ cần thiết</h3>
            </div>
            <div className="space-y-3">
              {[
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center mb-2">
                ...
                <span className="font-bold text-yellow-700">Lưu ý quan trọng:</span>
              </div>
              <p className="text-yellow-700 text-sm">
                Tất cả giấy tờ phải là bản gốc hoặc bản sao có công chứng. 
                Người tham gia xét nghiệm phải có mặt trực tiếp tại cơ sở.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/50 backdrop-blur-sm rounded-xl p-5">
              <div className="flex items-center mb-3">
                ...
                <h4 className="text-lg font-semibold text-gray-800">Thời gian</h4>
              </div>
              <p className="text-gray-700 text-sm leading-relaxed">
                Kết quả xét nghiệm có giá trị vĩnh viễn, không có thời hạn sử dụng 
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-xl p-5">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Thông tin xét nghiệm được bảo mật tuyệt đối theo quy định pháp luật, 
                chỉ cung cấp cho người có quyền.
              </p>
            </div>
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-xl p-5">
              <div className="flex items-center mb-3">
                ...
                <h4 className="text-lg font-semibold text-gray-800">Công nhận</h4>
              </div>
              <p className="text-gray-700 text-sm leading-relaxed">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mt-15">
            {[
              { icon: User, title: 'Tư vấn và chuẩn bị', subtitle: 'giấy tờ cần thiết', color: 'from-emerald-300 to-emerald-400' },
              { icon: TestTube, title: 'Thu mẫu có giám sát', subtitle: 'theo quy định pháp lý', color: 'from-teal-300 to-teal-400' },
              { icon: Mail, title: 'Vận chuyển mẫu', subtitle: 'an toàn đến phòng lab', color: 'from-green-300 to-green-400' },
              { icon: CheckSquare, title: 'Phân tích chuyên sâu', subtitle: 'với công nghệ hiện đại', color: 'from-emerald-400 to-teal-400' },
              { icon: FileText, title: 'Cấp kết quả', subtitle: 'có giá trị pháp lý', color: 'from-teal-400 to-green-400' }
            ].map((step, index) => (
        ...
        <div className="bg-gradient-to-r from-slate-700 via-gray-700 to-slate-800 rounded-3xl shadow-2xl p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">Danh sách dịch vụ hành chính</h2>
              <p className="text-gray-300 text-lg">Dịch vụ xét nghiệm ADN có giá trị pháp lý</p>
                    ...
                    <div className="p-8">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-2">
                          {service.priceListRequest.map((item, idx) => (
                            <div key={idx} className="bg-gradient-to-r from-emerald-50 to-teal-50 p-4 rounded-xl border border-emerald-100">
                      ...
                      <div className="text-center">
                        <Button
                          ...
                          sx={{
                            background: 'linear-gradient(45deg, #10b981 30%, #14b8a6 90%)',
                            color: 'white',
                            padding: '12px 32px',
                            borderRadius: '12px',
                            fontWeight: 'bold',

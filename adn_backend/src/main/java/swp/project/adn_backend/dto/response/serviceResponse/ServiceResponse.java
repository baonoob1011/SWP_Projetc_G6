...
public class ServiceResponse {
    ...
    public ServiceResponse(long serviceId, String serviceName, LocalDate registerDate, String description, ServiceType serviceType, boolean isActive, String image, List<PriceList> priceLists) {

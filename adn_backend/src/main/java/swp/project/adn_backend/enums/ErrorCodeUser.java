...
public enum ErrorCodeUser {
    ...
    LOCATION_NOT_EXISTS(1001, "location does not exist", HttpStatus.BAD_REQUEST),
    ...
    PASSWORD_EXISTED(1001, "Password already exists", HttpStatus.BAD_REQUEST),
    SERVICE_NOT_EXISTED(1001, "Service does not exist", HttpStatus.BAD_REQUEST),
    STAFF_NOT_EXISTED(1001, "Staff does not exist", HttpStatus.BAD_REQUEST),
    USER_DISABLED(1001, "User account is not active", HttpStatus.BAD_REQUEST),
    ...
    PASSWORD_WEAK(1004, "Password must include at least one uppercase letter, one digit, and one special character", HttpStatus.BAD_REQUEST),
    ...
    PHONE_INVALID(1009, "Phone number must be between 9 and 15 digits", HttpStatus.BAD_REQUEST),
    ...
    PHONE_EXISTED(1014, "Phone number is already in use", HttpStatus.BAD_REQUEST),
    ADDRESS_EXISTED(1014, "Address is already in use", HttpStatus.BAD_REQUEST),
    INVALID_KEY(1015, "Invalid verification key", HttpStatus.BAD_REQUEST),
    ...
    USER_NOT_EXISTED(1018, "User does not exist", HttpStatus.BAD_REQUEST),
    ...
    PHONE_NOT_EXISTS(1008, "Phone number does not exist", HttpStatus.BAD_REQUEST),

    // Service validation
    SERVICE_NAME_IS_EXISTED(1001, "Service name already exists", HttpStatus.BAD_REQUEST),
    SERVICE_NOT_EXISTS(1001, "Service does not exist", HttpStatus.BAD_REQUEST),
